...
const JobSeekerLogin = () => {
  ...
  const { JobSeekerLogin, setShowJobSeekerOtpPage } = useContext(JobContext);
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (otpResponse.ok) {
        setIsOtpSent(true);
        JobSeekerLogin(phoneNumber); // Trigger the login flow in context
  ...
  useEffect(() => {
    if (isOtpSent) {
      setShowJobSeekerOtpPage(true); // Show OTP page
    }
  }, [isOtpSent, setShowJobSeekerOtpPage]);
