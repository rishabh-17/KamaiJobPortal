...
const Header = () => {
  const { handleOpenForm, isSticky, handleOpen, handleOpenModal } =
    useContext(JobContext);
  const [announcement, setAnnouncement] = useState(true);

  return (
    <header className="heater-transparent bg-white mb-56">
      <div
      ...
      <div
        className={`jm-header-area-2 jm_border_bottom jm-header-padding header-sticky sticky bg-white`}
      >
          ...
          <div className="row align-items-center ">
            ...
            <div className="col-xl-3 col-lg-3 col-5">
              <div className="jm-header-right jm-header-right-2 text-end  d-flex align-items-center justify-content-end">
                ...
                <Link
                  to="#"
                  className="jm-profile jm-header-action-profile"
                  role="button"
