        ...
        <div className="row align-items-center">
          <div className="col-xl-3">
            <div className="jm-work-left-2 mb-40 text-center text-xl-start">
              <div className="jm-section-title text-white mb-25">
                <h2 className="title text-white text-white">
                  Choose Your work
                </h2>
              ...
              <div className="jm-work-btn-2">
                <Link
                  to="/jobCategoryPage"
                  className="jm-theme-btn jm-theme-btn-black text-white hover:border-white"
                >
                  View More Jobs
                </Link>
              </div>
              ...
              <div className="row g-0">
                <div className="col-xl-4 col-lg-4 col-md-6 col-sm-6 jm-border-2">
                  <div className="jm-work-item-2">
                    ...
                    <div className="jm-work-item-content-2">
                      <h4 className="title text-white text-white">
                        <Link to="/serviceDetailsPage text-white">
                          Register
                        </Link>
                      </h4>
                  ...
                  <div className="jm-work-item-2">
                    ...
                    <div className="jm-work-item-content-2">
                      <h4 className="title text-white">
                        <Link to="/serviceDetailsPage">Search</Link>
                      </h4>
                      <p className="text-white">
                ...
                <div className="col-xl-4 col-lg-4 col-md-6 col-sm-6 jm-border-2">
                  <div className="jm-work-item-2">
                    ...
                    <div className="jm-work-item-content-2">
                      <h4 className="title text-white">
                        <Link to="/serviceDetailsPage">Apply Jobs</Link>
                      </h4>
                      <p className="text-white">
