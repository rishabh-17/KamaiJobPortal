            ...
            <ul>
              ...
              <li className="menu-has-children">
                ...
                <ul className={`sub-menu ${isMenuExpanded(2) ? "" : "d-none"}`}>
                  ...
                  <li>
                    <Link to="/candidateDetailsPage">Candidates Details</Link>
                  </li>
                </ul>
                <Link
                  className={`mean-expand ${
                    isMenuExpanded(2) ? "mean-clicked" : ""
                  }`}
                  role="button"
                  to="#"
